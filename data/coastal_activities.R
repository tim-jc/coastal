coastal_activities <- dplyr::tribble(
  ~activity_id , ~from            , ~to              , ~ride_direction , ~riders                 , ~ride_start_time , ~ride_end_time ,
   ...
   19881072524 , "broadford"      , "strathcarron"   , "cw"            , "TC|TS|(SB)|(WR)"       ,               10 ,           7930 ,
   19867101376 , "teangue"        , "broadford"      , "cw"            , "TC|TS"                 ,              760 ,          16500 ,
    7076591578 , "acharacle"      , "teangue"        , "cw"            , "TC|SB|WR|(TS)"         ,                0 ,          21150 ,
